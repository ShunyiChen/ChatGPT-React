...
function Getstarted() {
    ...
    return (
        <div className='' style={{width:"100vw", height:"100vh"}}>
            {capacity? (
             <div className='w-100 h-100' style={{overflow:"auto", backgroundColor:"white"}}>
                <div className="d-flex flex-row flex-nowrap align-items-center justify-content-center" style={{overflow:"hidden", position:"relative"}}>
                    <div className='flex-shrink-0 d-flex flex-column flex-nowrap align-items-start justify-content-center' 
                        style={{paddingTop:"8rem", paddingLeft:"3.5rem", paddingRight:"3.5rem", width:"60%", overflow:"auto", gap:"1.5rem", marginLeft:"auto", marginRight:"auto"}}>
                            ...
                            <a href="https://share.hsforms.com/13gyIEVN5SrScw-iVvCgIew4sk30" target="_blank" rel="noreferrer" style={{color:"black"}}>Get notified when we're back</a>
            ...
            <div className="d-flex flex-row mb-0 w-100 h-100">
                ...
                <div id="getStartedRight" className='d-flex flex-column getStartedRightTheme' style={{ width: "40%", minWidth: "416px", marginTop: "-17px" }}>
                    ...
                    <div className="p-2 d-flex flex-column justify-content-center" style={{ height: "100%" }}>
                        ...
                        <div id="getStartedButtons" className="mt-3 d-flex flex-wrap justify-content-center" style={{ gap: "0.73rem" }}>
                            <button type="button" className="btn getstartedButton" onClick={signIn}>Log in</button>
                            <button type="button" className="btn getstartedButton" onClick={signUp}>Sign up</button>
                        </div>
                    </div>
