...
function SignIn() {
    ...
    return (
        <div className="d-flex flex-column align-items-center" style={{width:"100%", backgroundColor:"white", overflow:"auto", paddingTop:"32px"}}>
                    ...
                    <div>
                        <form>
                            <div className="form-floating">
                                <input type="email" className="form-control" id="floatingInput" placeholder="name@example.com" style={{width:"320px", height:"52px"}} onFocus={() => setReqiestFocus(true)} onBlur={() => setReqiestFocus(false)}/>
                                <label className="floatingInput" style={{color:reqiestFocus?"#10A37F":"grey"}}>Email address</label>
                            </div>
                        ...
                        <div className='d-flex flex-row justify-content-center' style={{fontSize:"14px", marginTop:"16px", height:"17px"}}>
                            <p>Don't have an account?
                                <a href="#" className="link-success text-decoration-none" style={{padding:"0px 5px"}}>Sign up</a>
                            </p>
                        </div>
                        ...
                        <div className='d-flex flex-column justify-content-center' style={{marginTop:"24px"}}>
                            <form action="" style={{marginBottom:"8px"}}>
                                <button type="button" className="btn ContinueWithButton">
                                    <span className='px-2'>
                                        <img src={getIcon('Google.svg')} alt="" />
                                    </span>
                            ...
                            <form action="" style={{marginBottom:"8px"}}>
                                <button type="button" className="btn ContinueWithButton">
                                    <span className='px-2'>
                                        <img src={getIcon('Microsoft.svg')} alt="" />
                                    </span>
                            ...
                            <form action="" style={{marginBottom:"8px"}}>
                                <button type="button" className="btn ContinueWithButton">
                                    <span className='px-2'>
                                        <img src={getIcon('Apple.svg')} alt="" style={{width:"20px"}}/>
                                    </span>
            ...
            <footer className='d-flex flex-row justify-content-center align-items-center' style={{padding:"12px 0 24px", fontSize:"14px", width:"100%"}}>
                <a href="https://openai.com/policies/terms-of-use" target="_blank" className="mx-2 text-decoration-none  align-items-end" rel="noreferrer" style={{color:"#10A37F", textAlign:"right"}}>Terms of use</a>
                <span className='link-secondary'>|</span>
                <a href="https://openai.com/policies/privacy-policy" target="_blank" className="mx-2 text-decoration-none" rel="noreferrer" style={{color:"#10A37F"}}>Privacy policy</a>
            </footer>
